...
namespace Examen_Final.Controllers
{
    ...
    {
        private Examen_Final_WebEntities db = new Examen_Final_WebEntities();
        ...
        public ActionResult Create([Bind(Include = "ID,NOMBRE,APELLIDO,identidad,fecha")] contacto contacto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,NOMBRE,APELLIDO,identidad,fecha")] contacto contacto)
        {
            if (ModelState.IsValid)
            {
